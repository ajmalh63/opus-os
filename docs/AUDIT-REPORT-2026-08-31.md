...
**Still open (owner-dependent or scheduled):** ~~P0-2~~ (owner deprioritized) · ~~P1-1~~ ✅ complete · P1-3 publishes at the client-facing mutation surface done; *remaining*: client-side channel subscriptions (P2-1) · P2-1 portal split · P2-4 tracing · P2-6 apiClient (core built; adopt in remaining components). **Fixed this pass: P1-2 deny matrix, P1-5, P2-3, P2-6 core, P2-7, P1-1 (complete), P2-2 (code-side), P1-3 backend surface + safeExecutionCtx fix.**
