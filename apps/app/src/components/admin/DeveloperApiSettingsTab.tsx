...
const ALL_SCOPES = [
  ...
  { key: 'recruitment:read', label: 'Recruitment: Read', desc: 'List overseas job demands' },
  { key: 'recruitment:write', label: 'Recruitment: Write', desc: 'Create overseas job postings' },
  { key: 'bookings:read', label: 'Bookings: Read', desc: 'List Cal.com consultation appointments' },
  { key: 'bookings:write', label: 'Bookings: Write', desc: 'Update appointment status' },
  { key: 'payments:read', label: 'Payments: Read', desc: 'Query payment ledger & invoices' },
  { key: 'documents:read', label: 'Documents: Read', desc: 'List client vault documents' },
  { key: 'documents:write', label: 'Documents: Write', desc: 'Mark documents verified or rejected' },
  { key: 'partners:read', label: 'Partners: Read', desc: 'List affiliates & referral codes' },
  { key: 'messages:write', label: 'Messages: Write', desc: 'Send outbound WhatsApp messages' },
