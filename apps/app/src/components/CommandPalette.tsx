...
const PUBLIC_COMMANDS = [
  ...
  { key: 'tours-travels', label: 'Tours & Travels (Holidays & Packages)', to: '/tours-travels', section: 'Divisions', icon: 'M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z' },
  { key: 'umrah-travel', label: 'Umrah Pilgrimages & 5-Star Group Departures', to: '/umrah-travel', section: 'Divisions', icon: 'M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z' },
  ...
  { key: 'recruitment', label: 'Overseas Manpower Services & Jobs', to: '/manpower', section: 'Divisions', icon: 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z' },
  { key: 'employer-hire', label: 'Employer Hire Desk (Hire Skilled Manpower)', to: '/manpower/hire', section: 'Divisions', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
  { key: 'blog', label: 'Opus Intelligence & Immigration Insights Blog', to: '/blog', section: 'Resources', icon: 'M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z' },
