...
CREATE TABLE `__new_attestation_applications` (
	...
	`courier_return` text,
	`stage` text DEFAULT 'quote_requested' NOT NULL,
	`document_key` text,
	`document_status` text DEFAULT 'missing' NOT NULL,
...
INSERT INTO `__new_attestation_applications`("id", "client_id", "document_type", "destination_country", "current_step", "status", "document_json", "category", "route", "chain_json", "govt_fee_paise", "service_fee_paise", "courier_fee_paise", "translation_fee_paise", "total_quote_paise", "translation_needed", "pickup_status", "pickup_address", "courier_inbound", "courier_outbound", "courier_return", "stage", "document_key", "document_status", "payment_status", "paid_amount_paise", "notes", "created_at", "updated_at") SELECT "id", "client_id", "document_type", "destination_country", "current_step", "status", "document_json", "category", "route", "chain_json", "govt_fee_paise", "service_fee_paise", "courier_fee_paise", "translation_fee_paise", "total_quote_paise", "translation_needed", "pickup_status", "pickup_address", "courier_inbound", "courier_outbound", "courier_return", "stage", "document_key", "document_status", "payment_status", "paid_amount_paise", "notes", "created_at", "updated_at" FROM `attestation_applications`;--> statement-breakpoint
